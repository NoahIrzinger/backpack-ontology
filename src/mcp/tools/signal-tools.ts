...
export function registerSignalTools(
  ...
  server.registerTool(
    "backpack_signal_list",
    {
      title: "List Signals",
      description:
        "List active signals for the current backpack. Signals are derived insights — concentration risks, bridge nodes, orphan clusters, cross-graph entities — computed from graph structure and KB content. Filter by graph, kind, severity, or text search. Search 'my-graph' to find signals touching my-graph across all graphs.",
      inputSchema: {
